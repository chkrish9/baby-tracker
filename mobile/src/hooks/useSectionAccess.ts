import { ALL_SECTIONS, Section } from "@/lib/sections";
...
// Mirrors web/src/hooks/usePermissions.ts's useBabyPermissions.
export function useSectionAccess(babyId: string | undefined) {
