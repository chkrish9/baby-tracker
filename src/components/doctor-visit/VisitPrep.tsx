...
export function VisitPrep({ babyId, appointmentId }: VisitPrepProps) {
  ...
  async function handleAddQuestion(e: React.FormEvent) {
    ...
    const res = await fetch(`/api/babies/${babyId}/doctor-notes`, {
      method: "POST",
  ...
  async function handleToggleAnswered(note: DoctorNoteItem) {
    const res = await fetch(`/api/babies/${babyId}/doctor-notes/${note.id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
  ...
  async function handleDeleteQuestion(id: string) {
    const res = await fetch(`/api/babies/${babyId}/doctor-notes/${id}`, { method: "DELETE" });
